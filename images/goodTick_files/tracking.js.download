(function(w, d, n) {
    ...
    var blackList = {
        ...
        pathPrefixes: [
            ...
            'https://www.cloudflare.com/media-and-entertainment'
        ]
    };
    ...
    if (w[trackingName].client && w[trackingName].client !== '') {
        ...
        if (blackList.cids.indexOf(cid) === -1) {
            ...
            if (!blocked) {
                ...
                i.src = 'https://apt.techtarget.com/activity/activity.gif?activityTypeId=31&cid=' + w[trackingName].client + '&version=' + version + '&ref=' + referrer + '&r=' + Date.now();
